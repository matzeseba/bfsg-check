...
export async function exportUserData(email) {
  ...
  return {
    ...
    subscriptions,
    notice: 'Diese Daten umfassen alle in Barrierefrei-Prüfen persistierten Records zu Ihrer E-Mail. Stripe-Daten + E-Mail-Versand-Logs (Brevo) müssen separat angefragt werden.'
  };
}
