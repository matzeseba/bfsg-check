...
Gründer Matthias Seba. "Es geht darum, in 5 Minuten zu wissen, wo Du 
...
**Bild-Empfehlung:** Screenshot der Landing-Page + Score-Beispiel (siehe `marketing/og-image-1200x630.png` falls vorhanden) — bei ots/Presseportal +275 € Bildversand.
...
## Direkt-Pitch (NICHT Cold-Mail — redaktionelle Anfrage):
...
- Themen-Bezug klar
- Einmalig
- Klarer Abmelde-Hinweis im Footer
- Keine Tracking-Pixel
- Bietet echten redaktionellen Wert (Daten)
