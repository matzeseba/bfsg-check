...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://barrierefrei-pruefen.de/cookie-banner-fehler",
    type: "article",
  },
};
      ...
      <article className="mx-auto w-full max-w-3xl px-6 py-16">
        ...
        <section className="mt-14 rounded-2xl border border-border bg-card/60 px-6 py-8">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Der Barrierefrei-Prüfen Cookie-Basis-Check (39 €) prüft automatisiert, welche Tracker vor Consent feuern,
        ...
        <aside className="mt-12 rounded-xl border border-border bg-muted/30 px-5 py-4 text-xs leading-relaxed text-muted-foreground">
          ...
          Barrierefrei-Prüfen liefert automatisierte technische Analysen nach WCAG 2.1 AA. Keine Garantie für
