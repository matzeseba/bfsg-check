...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://barrierefrei-pruefen.de/barrierefreiheitserklaerung-muster",
    type: "article",
  },
};
...
Eingesetztes Verfahren: [automatisierte technische Analyse nach WCAG 2.1 AA mittels Barrierefrei-Prüfen]
    ...
    <>
      ...
      <article className="mx-auto w-full max-w-3xl px-6 py-16">
        ...
        <section className="mt-14 rounded-2xl border border-border bg-card/60 px-6 py-8">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Barrierefrei-Prüfen erstellt im Rahmen des Basis-Reports (129 €) einen Entwurf Ihrer
        ...
        <aside className="mt-12 rounded-xl border border-border bg-muted/30 px-5 py-4 text-xs leading-relaxed text-muted-foreground">
          ...
          keine anwaltliche Prüfung. Barrierefrei-Prüfen liefert automatisierte technische Analysen, keine
