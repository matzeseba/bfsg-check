...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://barrierefrei-pruefen.de/axe-lighthouse-wave-vergleich",
    type: "article",
  },
};
  ...
  return (
    <>
      ...
      <article className="mx-auto w-full max-w-3xl px-6 py-16">
        ...
        {/* Wie Barrierefrei-Prüfen Tools kombiniert */}
        <section className="mt-14">
          <h2 className="text-2xl font-semibold">Wie Barrierefrei-Prüfen die Tools kombiniert</h2>
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
            Barrierefrei-Prüfen setzt axe-core als Primär-Engine ein und ergänzt eigene Prüfregeln für über 80
        ...
        <aside className="mt-12 rounded-xl border border-border bg-muted/30 px-5 py-4 text-xs leading-relaxed text-muted-foreground">
          ...
          Forschungsdaten — tatsächliche Werte variieren je nach Website. Barrierefrei-Prüfen liefert automatisierte
